...
Once you have installed oTree and created an app you are ready to build your own experiment.

If you examine an experiment, you will see that from a programming-perspective an experiment consists of some things. These can be seen as the four building blocks of oTree.
